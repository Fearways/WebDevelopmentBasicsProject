<div class="row">
    ...
    if(true) :?>
        <div class="panel panel-default col-md-12 margin-right">
            ...
            <?php endif; ?>
            <?php if (in_array($_SESSION['username'], $conference->getAdmins()) || (\Framework\App::getInstance()->isLogged() && ($conference->getOwner() === $_SESSION['username'])) || ($_SESSION['role'] == 'site administrator')/* || $_SESSION['role'] === 'conference administrator'*/) : ?>
